...
import com.example.holidayapp.view.viewmodel.HolidayViewModel3;
...
public class ItemFragment3 extends Fragment {
    ...
    private HolidayViewModel3 holidayViewModel;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Log.d("ItemFragment3", "OnCreateView");
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        holidayViewModel = new ViewModelProvider(this).get(HolidayViewModel3.class);
