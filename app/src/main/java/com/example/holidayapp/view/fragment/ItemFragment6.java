...
public class ItemFragment6 extends Fragment {
    ...
    private HolidayViewModel6 holidayViewModel;
    private RecyclerView rvHoliday;

    public ItemFragment6() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Log.d("ItemFragment6", "OnCreateView");
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        holidayViewModel = new ViewModelProvider(this).get(HolidayViewModel6.class);
