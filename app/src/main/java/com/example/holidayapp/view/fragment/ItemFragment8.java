...
import com.example.holidayapp.view.viewmodel.HolidayViewModel8;
...
public class ItemFragment8 extends Fragment {
    ...
    private HolidayViewModel8 holidayViewModel;
    private RecyclerView rvHoliday;

    public ItemFragment8() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Log.d("ItemFragment8", "OnCreateView");
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        holidayViewModel = new ViewModelProvider(this).get(HolidayViewModel8.class);
