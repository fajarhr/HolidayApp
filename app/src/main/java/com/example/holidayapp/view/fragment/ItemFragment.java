...
import com.example.holidayapp.database.HolidayModelDB;
...
public class ItemFragment extends Fragment {
    ...
    private ArrayList<HolidayModelDB> listHolidayFav = new ArrayList<>();
    private AppDatabase appDatabase;
    private HolidayAdapter favoriteMovieAdapter;
