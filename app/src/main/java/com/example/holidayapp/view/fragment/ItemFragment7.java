...
import com.example.holidayapp.view.viewmodel.HolidayViewModel6;
import com.example.holidayapp.view.viewmodel.HolidayViewModel7;
...
public class ItemFragment7 extends Fragment {
    ...
    private HolidayViewModel7 holidayViewModel;
    private RecyclerView rvHoliday;

    public ItemFragment7() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Log.d("ItemFragment7", "OnCreateView");
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        holidayViewModel = new ViewModelProvider(this).get(HolidayViewModel7.class);
