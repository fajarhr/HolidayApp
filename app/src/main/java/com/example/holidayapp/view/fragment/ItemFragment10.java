...
import com.example.holidayapp.view.viewmodel.HolidayViewModel10;
...
public class ItemFragment10 extends Fragment {
    ...
    private HolidayViewModel10 holidayViewModel;
    private RecyclerView rvHoliday;

    public ItemFragment10() {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        holidayViewModel = new ViewModelProvider(this).get(HolidayViewModel10.class);
