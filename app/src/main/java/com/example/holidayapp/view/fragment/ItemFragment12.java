...
import com.example.holidayapp.view.viewmodel.HolidayViewModel12;
...
public class ItemFragment12 extends Fragment {
    ...
    private HolidayViewModel12 holidayViewModel;
    private RecyclerView rvHoliday;

    public ItemFragment12() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Log.d("ItemFragment12", "OnCreateView");
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        holidayViewModel = new ViewModelProvider(this).get(HolidayViewModel12.class);
