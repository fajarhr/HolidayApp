...
import com.example.holidayapp.view.viewmodel.HolidayViewModel9;
...
public class ItemFragment9 extends Fragment {
    ...
    private HolidayViewModel9 holidayViewModel;
    private RecyclerView rvHoliday;

    public ItemFragment9() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Log.d("ItemFragment9", "OnCreateView");
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        holidayViewModel = new ViewModelProvider(this).get(HolidayViewModel9.class);
